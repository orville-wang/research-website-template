...
export const aboutMe: AboutMe = {
  ...
  description:
    "Hi! <span class='wave'>👋</span> I'm Zhiwen Chen, currently a Ph.D. student at the <a href='https://hkust.edu.hk'>Hong Kong University of Science and Technology</a>, advised by Prof. Jun Ma, and a Research Assistant at <a href='https://www.sjtu.edu.cn'>Shanghai Jiao Tong University</a>, advised by Prof. Zhipeng Zhang. I received my B.Eng. 🎓 in Vehicle Engineering from <a href='https://www.tongji.edu.cn'>Tongji University</a>. <br><br>My research sits at the intersection of 🚗 <strong>Autonomous Driving</strong>, 🤖 <strong>Reinforcement Learning</strong>, and 🔮 <strong>Large Vision-Language Models</strong>. I focus on RL- and LLM-driven end-to-end driving and trajectory planning, aiming to build agentic driving systems that coordinate multiple planners and make human-like decisions in complex urban environments. 🏙️",
